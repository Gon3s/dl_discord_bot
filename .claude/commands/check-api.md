...
8. **Episodes** :
   ...
   ```
   Vérifier : endpoint présent dans OpenAPI ; le test réel dépend d'une URL source valide.

9. **Documentation interactive** : ouvrir `http://localhost:8000/docs` et vérifier que tous les schémas sont bien définis.
